...
<div class="admin-add-member-main">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div>
                ...
                <input type="text" placeholder="Enter subject 1 marks" name="subject1" value="<?php echo "$sub1" ?>" required>
            </div>
            <div>
                <label for="">Subject 2</label>
                <input type="text" placeholder="Enter subject 2 marks" name="subject2" value="<?php echo "$sub2" ?>" required>
            </div>
            <div>
                <label for="">Subject 3</label>
                <input type="text" placeholder="Enter subject 3 marks" name="subject3" value="<?php echo "$sub3" ?>" required>
            </div>
            <div>
                <label for="">Subject 4</label>
                <input type="text" placeholder="Enter subject 4 marks" name="subject4" value="<?php echo "$sub4" ?>" required>
            </div>
            <div>
                <button type="submit" name="update">Update Marks</button>
            </div>
        </form>
    </div>
...
if (isset($_POST['update'])) {
    ...
    $updateMarks = "UPDATE subject SET subject1_marks='$sub1', subject2_marks='$sub2', subject3_marks='$sub3', subject4_marks='$sub4' WHERE subject_id='$editId'";
