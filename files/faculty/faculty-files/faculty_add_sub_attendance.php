    ...
    <div class="add-semester-div">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" placeholder="Enter Attendance" name="subject1Attendance" required>
            </div>
            <div>
                <label for="">Subject 2</label>
                <input type="text" placeholder="Enter Attendance" name="subject2Attendance" required>
            </div>
            <div>
                <label for="">Subject 3</label>
                <input type="text" placeholder="Enter Attendance" name="subject3Attendance" required>
            </div>
            <div>
                <label for="">Subject 4</label>
                <input type="text" placeholder="Enter Attendance" name="subject4Attendance" required>
            </div>
            <div>
            <button type="submit" class='add-semester-btn' name="submit">Add Attendance</button>
            </div>
        </form>
    </div>
...
if (isset($_POST['submit'])) {
    ...
    $subject1 = $_POST['subject1Attendance'];
    $subject2 = $_POST['subject2Attendance'];
    $subject3 = $_POST['subject3Attendance'];
    $subject4 = $_POST['subject4Attendance'];
    
    $insertStudent = "INSERT INTO attendance(subject1_attendance,subject2_attendance,subject3_attendance,subject4_attendance,semester_id,student_id) VALUES ('$subject1', '$subject2', '$subject3', '$subject4', '$semester', '$studentId')";
    ...
    if ($runInsertStudent) {
        ...
        echo "<script>
        setTimeout(function(){window.open('faculty_attendance.php', '_self')}, 3000);
        </script>";
    }
    else {
        echo "<script>            
        ...
        echo "<script>
        setTimeout(function(){window.open('faculty_add_sub_attendance.php', '_self') }, 3000);
        </script>";
    }
}
?>
