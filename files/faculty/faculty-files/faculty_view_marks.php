...
FROM subject 
INNER JOIN semester 
ON subject.semester_id=semester.semester_id WHERE semester.student_id=$studentMarksId;";
...
<?php
    ...
    <td>" .$row["subject4_marks"]. "</td>
            ...
            <td></td>
            <td> 
            <a class='edit-btn' href='faculty_edit_marks.php?editId=$row[subject_id]&sub1=$row[subject1_marks]&sub2=$row[subject2_marks]&sub3=$row[subject3_marks]&sub4=$row[subject4_marks]'>Edit</a> 
            <a href='faculty_delete_marks.php?delId=$row[subject_id]'>Delete</a> 
            </td>
            </tr>";
            ?>
            </table>
...
echo "
<div class='faculty-add-marks-btn-div'>
<a class='faculty-add-marks-btn' href='faculty_add_semester.php?addId=$studentMarksId'>Add Marks</a>
</div>";
    ...
    <footer>
        <div>
            ...
            <div>
                ...
                <a href="faculty_attendance.php" class="navbar-anchor-links">Attendance</a>
