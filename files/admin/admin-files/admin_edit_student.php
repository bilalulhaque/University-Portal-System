  ...
  <div class="container-fluid">
    ...
    <div class="admin-add-member-main">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div>
                <button type="submit" name="update">Update Student Data</button>
            </div>
        </form>
    </div>
...
if (isset($_POST['update'])) {
    ...
    $updateStudent = "UPDATE student SET firstname='$firstname', lastname='$lastname', email='$email', username='$username', password='$password' WHERE student_id='$editId'";
    ...
    if ($runUpdateStudent) {
        ...
        echo "<script>
        setTimeout(function(){window.open('admin_edit_student.php', '_self')}, 3000);
        </script>";
    }
    else {
        echo "<script>            Swal.fire({
