...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="admin-add-member-main">
        <h2>Add Faculty</h2>
        <form action="admin_add_faculty.php" method="POST" enctype="multipart/form-data">
            <div>
...
if (isset($_POST['add'])) {
    ...
    $insertFaculty = "INSERT INTO faculty(firstname, lastname, email, username, password, designation) VALUES ('$firstname','$lastname','$email','$username','$password','$designation')";
   
    $runInsertFaculty = mysqli_query($conn, $insertFaculty);
    if ($runInsertFaculty) {
        ...
        echo "<script>
        setTimeout(function(){window.open('admin_add_faculty.php', '_self')}, 3000);
        </script>";
    }
    else {
        echo "<script>            
